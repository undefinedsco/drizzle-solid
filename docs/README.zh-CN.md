...
- `docs/api/README.md`：从任务出发的 API 参考
...
- `docs/guides/testing.md`：测试分层、examples 验证、parity 与 execution-path 护栏
...
- 做测试与发布：`docs/guides/testing.md` → `ACTION-PLAN.md` → `tests/fixtures/drizzle-parity/queue.json`
